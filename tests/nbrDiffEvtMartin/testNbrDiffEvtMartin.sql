...
--		  		requete testNbrDiffEvtMartin.sql.
-- projet : 	Billeterie
-- ==================================================
...
VALUES (1, '15ED68EP10EPD84', 1, 1, 1, 1);

INSERT INTO tarif (idtarif, prix, typetarif)
VALUES (2, 50, 'enfant');
INSERT INTO billet (idbillet, codebillet, idcli, idtarif, idsiteresa, idevt)
VALUES (2, '65QS82CD02POD65', 1, 2, 1, 1);
...
INSERT INTO billet (idbillet, codebillet, idcli, idtarif, idsiteresa, idevt)
VALUES (3, '85PO36DM19CBD45', 1, 1, NULL, 2);
...
INSERT INTO billet (idbillet, codebillet, idcli, idtarif, idsiteresa, idevt)
VALUES (4, '65DE48IL37UDT88', 1, 4, NULL, 3);
...
-- CAS 4 : Paul Dupont a achete 1 billet
-- INSERTION D'UN NOUVEAU BILLET : Cas site resa
INSERT INTO client (idcli, nomcli, prenomcli, telcli, mailcli, adrcli)
...
SPOOL tests/nbrDiffEvtMartin/testNbrDiffEvtMartin.out
PROMPT fichier resultat du test : testNbrDiffEvtMartin.out
...
@ tests/nbrDiffEvtMartin/nbrDiffEvtMartin.sql
